...
const REGION_LIST = [
  { key: 'norway', icon: '\ud83c\uddf3\ud83c\uddf4', color: '#00d4ff' },
  { key: 'europe', icon: '\ud83c\uddea\ud83c\uddfa', color: '#3b82f6' },
  { key: 'global', icon: '\ud83c\udf0d', color: '#a855f7' },
];
...
const LAYERS = [
  ...
  { key: 'satellites', label: 'SATELLITES', icon: '\ud83d\udef0', color: '#a855f7', desc: 'CelesTrak TLE' },
  { key: 'airspaces', label: 'AIRSPACE', icon: '\ud83d\udee1', color: '#f59e0b', desc: 'Restricted Zones' },
  { key: 'gpsJamming', label: 'GPS JAMMING', icon: '\ud83d\udce1', color: '#ef4444', desc: 'EW Interference' },
  { key: 'geofences', label: 'GEOFENCES', icon: '\ud83c\udfaf', color: '#f43f5e', desc: 'AOI Alert Zones' },
];

const FILTERS = [
  { key: 'normal', label: 'STD', icon: '\u25c9' },
  { key: 'nightvision', label: 'NV', icon: '\ud83d\udfe2' },
  { key: 'thermal', label: 'FLIR', icon: '\ud83d\udd34' },
